...
public class VistaIndex {
        ...
        private void createRoot() {
                ...
                pPlay.setOnMouseClicked(e -> {
                        AudioClip sonido = java.applet.Applet
        ...
        private void getTimeLineIntro() {
                ...
                t.getKeyFrames().add(new KeyFrame(Duration.millis(1068),
                                (ActionEvent event) -> intro.getChildren().setAll(intro01)));

                t.getKeyFrames().add(new KeyFrame(Duration.millis(1102),
                                (ActionEvent event) -> intro.getChildren().setAll(intro02)));

                t.getKeyFrames().add(new KeyFrame(Duration.millis(1136),
                                (ActionEvent event) -> intro.getChildren().setAll(intro03)));

                t.getKeyFrames().add(new KeyFrame(Duration.millis(1170),
                                (ActionEvent event) -> intro.getChildren().setAll(intro04)));

                t.getKeyFrames().add(new KeyFrame(Duration.millis(1204),
                                (ActionEvent event) -> intro.getChildren().setAll(intro05)));

                t.getKeyFrames().add(new KeyFrame(Duration.millis(1238),
                                (ActionEvent event) -> intro.getChildren().setAll(intro06)));

                t.getKeyFrames().add(new KeyFrame(Duration.millis(1272),
                                (ActionEvent event) -> intro.getChildren().setAll(intro07)));
                ...
                t.getKeyFrames().add(new KeyFrame(Duration.millis(1340),
                                (ActionEvent event) -> intro.getChildren().setAll(intro09)));

                t.getKeyFrames().add(new KeyFrame(Duration.millis(1374),
                                (ActionEvent event) -> intro.getChildren().setAll(intro10)));

                t.getKeyFrames().add(new KeyFrame(Duration.millis(1408),
                                (ActionEvent event) -> intro.getChildren().setAll(intro11)));

                t.getKeyFrames().add(new KeyFrame(Duration.millis(1442),
                                (ActionEvent event) -> intro.getChildren().setAll(intro12)));

                t.getKeyFrames().add(new KeyFrame(Duration.millis(1476),
                                (ActionEvent event) -> intro.getChildren().setAll(intro13)));

                t.getKeyFrames().add(new KeyFrame(Duration.millis(1510),
                                (ActionEvent event) -> intro.getChildren().setAll(intro14)));

                t.getKeyFrames().add(new KeyFrame(Duration.millis(1544),
                                (ActionEvent event) -> intro.getChildren().setAll(intro15)));

                t.getKeyFrames().add(new KeyFrame(Duration.millis(1578),
                                (ActionEvent event) -> intro.getChildren().setAll(intro16)));
                ...
                t.getKeyFrames().add(new KeyFrame(Duration.millis(1646),
                                (ActionEvent event) -> intro.getChildren().setAll(intro18)));

                t.getKeyFrames().add(new KeyFrame(Duration.millis(1680),
                                (ActionEvent event) -> intro.getChildren().setAll(intro19)));

                t.getKeyFrames().add(new KeyFrame(Duration.millis(1714),
                                (ActionEvent event) -> intro.getChildren().setAll(intro20)));

                t.getKeyFrames().add(new KeyFrame(Duration.millis(1748),
                                (ActionEvent event) -> intro.getChildren().setAll(intro21)));

                t.getKeyFrames().add(new KeyFrame(Duration.millis(1782),
                                (ActionEvent event) -> intro.getChildren().setAll(intro22)));

                t.getKeyFrames().add(new KeyFrame(Duration.millis(1816),
                                (ActionEvent event) -> intro.getChildren().setAll(intro23)));

                t.getKeyFrames().add(new KeyFrame(Duration.millis(1850),
                                (ActionEvent event) -> intro.getChildren().setAll(intro24)));

                t.getKeyFrames().add(new KeyFrame(Duration.millis(1884),
                                (ActionEvent event) -> intro.getChildren().setAll(intro25)));

                t.getKeyFrames().add(new KeyFrame(Duration.millis(1918),
                                (ActionEvent event) -> intro.getChildren().setAll(intro26)));

                t.getKeyFrames().add(new KeyFrame(Duration.millis(1952),
                                (ActionEvent event) -> intro.getChildren().setAll(intro27)));

                t.getKeyFrames().add(new KeyFrame(Duration.millis(1986),
                                (ActionEvent event) -> intro.getChildren().setAll(intro28)));

                t.getKeyFrames().add(new KeyFrame(Duration.millis(2020),
                                (ActionEvent event) -> intro.getChildren().setAll(intro29)));

                t.getKeyFrames().add(new KeyFrame(Duration.millis(2054),
                                (ActionEvent event) -> intro.getChildren().setAll(intro30)));

                t.getKeyFrames().add(new KeyFrame(Duration.millis(2088),
                                (ActionEvent event) -> intro.getChildren().setAll(intro31)));

                t.getKeyFrames().add(new KeyFrame(Duration.millis(2122),
                                (ActionEvent event) -> intro.getChildren().setAll(intro32)));

                t.getKeyFrames().add(new KeyFrame(Duration.millis(2156),
                                (ActionEvent event) -> intro.getChildren().setAll(intro33)));

                t.getKeyFrames().add(new KeyFrame(Duration.millis(2190),
                                (ActionEvent event) -> intro.getChildren().setAll(intro34)));

                t.getKeyFrames().add(new KeyFrame(Duration.millis(2224),
                                (ActionEvent event) -> intro.getChildren().setAll(intro35)));

                t.getKeyFrames().add(new KeyFrame(Duration.millis(2258),
                                (ActionEvent event) -> intro.getChildren().setAll(intro36)));

                t.getKeyFrames().add(new KeyFrame(Duration.millis(2292),
                                (ActionEvent event) -> intro.getChildren().setAll(intro37)));

                t.getKeyFrames().add(new KeyFrame(Duration.millis(2326),
                                (ActionEvent event) -> intro.getChildren().setAll(intro38)));

                t.getKeyFrames().add(new KeyFrame(Duration.millis(2360),
                                (ActionEvent event) -> intro.getChildren().setAll(intro39)));

                t.getKeyFrames().add(new KeyFrame(Duration.millis(2394),
                                (ActionEvent event) -> intro.getChildren().setAll(intro40)));

                t.getKeyFrames().add(new KeyFrame(Duration.millis(2428),
                                (ActionEvent event) -> intro.getChildren().setAll(intro41)));

                t.getKeyFrames().add(new KeyFrame(Duration.millis(2462),
                                (ActionEvent event) -> intro.getChildren().setAll(intro42)));

                t.getKeyFrames().add(new KeyFrame(Duration.millis(2496),
                                (ActionEvent event) -> intro.getChildren().setAll(intro43)));

                t.getKeyFrames().add(new KeyFrame(Duration.millis(2530),
                                (ActionEvent event) -> intro.getChildren().setAll(intro44)));

                t.getKeyFrames().add(new KeyFrame(Duration.millis(2564),
                                (ActionEvent event) -> intro.getChildren().setAll(intro45)));

                t.getKeyFrames().add(new KeyFrame(Duration.millis(2598),
                                (ActionEvent event) -> intro.getChildren().setAll(intro46)));

                t.getKeyFrames().add(new KeyFrame(Duration.millis(2632),
                                (ActionEvent event) -> intro.getChildren().setAll(intro47)));

                t.getKeyFrames().add(new KeyFrame(Duration.millis(2666),
                                (ActionEvent event) -> intro.getChildren().setAll(intro48)));

                t.getKeyFrames().add(new KeyFrame(Duration.millis(2700),
                                (ActionEvent event) -> intro.getChildren().setAll(intro49)));

                t.getKeyFrames().add(new KeyFrame(Duration.millis(2734),
                                (ActionEvent event) -> intro.getChildren().setAll(intro50)));

                t.getKeyFrames().add(new KeyFrame(Duration.millis(2768),
                                (ActionEvent event) -> intro.getChildren().setAll(intro51)));

                t.getKeyFrames().add(new KeyFrame(Duration.millis(2802),
                                (ActionEvent event) -> intro.getChildren().setAll(intro52)));

                t.getKeyFrames().add(new KeyFrame(Duration.millis(2836),
                                (ActionEvent event) -> intro.getChildren().setAll(intro53)));

                t.getKeyFrames().add(new KeyFrame(Duration.millis(2870),
                                (ActionEvent event) -> intro.getChildren().setAll(intro54)));

                t.getKeyFrames().add(new KeyFrame(Duration.millis(2904),
                                (ActionEvent event) -> intro.getChildren().setAll(intro55)));

                t.getKeyFrames().add(new KeyFrame(Duration.millis(2938),
                                (ActionEvent event) -> intro.getChildren().setAll(intro56)));

                t.getKeyFrames().add(new KeyFrame(Duration.millis(2972),
                                (ActionEvent event) -> intro.getChildren().setAll(intro57)));
                ...
                t.getKeyFrames().add(new KeyFrame(Duration.millis(3040),
                                (ActionEvent event) -> intro.getChildren().setAll(intro59)));

                t.getKeyFrames().add(new KeyFrame(Duration.millis(3074),
                                (ActionEvent event) -> intro.getChildren().setAll(intro60)));

                t.getKeyFrames().add(new KeyFrame(Duration.millis(3108),
                                (ActionEvent event) -> intro.getChildren().setAll(intro61)));
                ...
                t.getKeyFrames().add(new KeyFrame(Duration.millis(3176),
                                (ActionEvent event) -> intro.getChildren().setAll(intro63)));

                t.getKeyFrames().add(new KeyFrame(Duration.millis(3210),
                                (ActionEvent event) -> intro.getChildren().setAll(intro64)));

                t.getKeyFrames().add(new KeyFrame(Duration.millis(3244),
                                (ActionEvent event) -> intro.getChildren().setAll(intro65)));

                t.getKeyFrames().add(new KeyFrame(Duration.millis(3278),
                                (ActionEvent event) -> intro.getChildren().setAll(intro66)));

                t.getKeyFrames().add(new KeyFrame(Duration.millis(3312),
                                (ActionEvent event) -> intro.getChildren().setAll(intro67)));
